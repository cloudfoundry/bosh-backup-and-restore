...
require (
	...
	github.com/cloudfoundry/bosh-utils v0.0.613
	github.com/cloudfoundry/socks5-proxy v0.2.176
...
require (
	code.cloudfoundry.org/clock v1.72.0 // indirect
	...
	github.com/cloudfoundry/config-server v0.1.280 // indirect
