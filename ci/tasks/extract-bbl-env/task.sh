...
# bbl print-env exports BOSH_GW_HOST (the jumpbox IP or hostname) and BOSH_GW_USER.
# Prefer these over regex-parsing BOSH_ALL_PROXY, which only matches IPv4 addresses.
